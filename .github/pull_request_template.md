...
- [ ] CHANGELOG.md will be auto-generated via semantic-release

## Commit Messages

<!-- Confirm conventional commits -->

- [ ] All commits follow [Conventional Commits](https://www.conventionalcommits.org/) format
- [ ] Commit messages are clear and descriptive
- [ ] Example: `feat: add SMS scheduling feature` or `fix: correct phone validation`
...
```typescript
// Code example demonstrating the change
```
